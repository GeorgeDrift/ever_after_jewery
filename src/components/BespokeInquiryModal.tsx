...
export const BespokeInquiryModal: React.FC<BespokeInquiryModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-[#1C1917]/50 backdrop-blur-xs flex items-center justify-center p-3 sm:p-6 animate-in fade-in duration-200">
      <div 
        className="relative w-full max-w-2xl bg-white border border-[#E5DFD5] rounded-2xl shadow-2xl overflow-hidden my-auto"
        ...
        {!submitted ? (
          <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-4 max-h-[80vh] overflow-y-auto">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="text-xs text-[#78716C] uppercase tracking-wider block mb-1">Full Name *</label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label className="text-xs text-[#78716C] uppercase tracking-wider block mb-1">Email Address *</label>
                <input
                  type="email"
                  required
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="text-xs text-[#78716C] uppercase tracking-wider block mb-1">Telephone Number *</label>
                <input
                  type="tel"
                  required
              ...
              <div>
                <label className="text-xs text-[#78716C] uppercase tracking-wider block mb-1">Consultation Focus</label>
                <select
                  value={serviceType}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="text-xs text-[#78716C] uppercase tracking-wider block mb-1">Preferred Diamond Shape</label>
                <select
                  value={shape}
              ...
              <div>
                <label className="text-xs text-[#78716C] uppercase tracking-wider block mb-1">Estimated Budget Range</label>
                <select
                  value={budget}
            ...
            <div>
              <label className="text-xs text-[#78716C] uppercase tracking-wider block mb-1">
            ...
            <div className="pt-3 border-t border-[#EAE4DA] flex items-center justify-between">
          ...
          <div className="p-8 text-center space-y-4">
            ...
            <p className="text-xs text-[#78716C] max-w-md mx-auto leading-relaxed">
              Thank you, <strong className="text-[#1C1917]">{fullName}</strong>. Our senior jewelry consultant will contact you at <strong>{email}</strong> within 24 hours to confirm your private viewing.
            </p>
            <div className="pt-2">
              <button
                onClick={onClose}
                className="px-5 py-2 rounded-full bg-[#FAF9F5] hover:bg-[#F2ECE1] border border-[#E5DFD5] text-[#1C1917] text-xs font-semibold uppercase tracking-wider transition-colors"
              >
                Close Window
              </button>
            </div>
