      ...
      >
        ...
        <div className="flex border-b border-[#E5DFD5] px-6 bg-[#FAF9F5] text-xs">
          <button
            ...
            className={`py-3 px-4 font-semibold uppercase tracking-wider flex items-center gap-2 border-b-2 transition-all ${
              activeTab === 'export' ? 'border-[#B28359] text-[#8C5B32]' : 'border-transparent text-[#78716C] hover:text-[#1C1917]'
            }`}
          >
          ...
          <button
            ...
            className={`py-3 px-4 font-semibold uppercase tracking-wider flex items-center gap-2 border-b-2 transition-all ${
              activeTab === 'guide' ? 'border-[#B28359] text-[#8C5B32]' : 'border-transparent text-[#78716C] hover:text-[#1C1917]'
            }`}
          >
          ...
          <button
            ...
            className={`py-3 px-4 font-semibold uppercase tracking-wider flex items-center gap-2 border-b-2 transition-all ${
              activeTab === 'preview' ? 'border-[#B28359] text-[#8C5B32]' : 'border-transparent text-[#78716C] hover:text-[#1C1917]'
            }`}
          >
        ...
        <div className="p-6 sm:p-8 max-h-[75vh] overflow-y-auto space-y-6">
          ...
          {activeTab === 'export' && (
            <div className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="p-5 rounded-2xl bg-[#FAF9F5] border border-[#E5DFD5] hover:border-emerald-500/50 transition-all space-y-4 flex flex-col justify-between shadow-xs">
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <div className="w-8 h-8 rounded-lg bg-emerald-100/60 flex items-center justify-center text-emerald-700">
                        <FileSpreadsheet className="w-4 h-4" />
                      </div>
                      <span className="text-[10px] text-emerald-700 font-mono font-semibold">.CSV Format</span>
                    </div>
                ...
                {/* Headless JSON Card */}
                <div className="p-5 rounded-2xl bg-[#FAF9F5] border border-[#E5DFD5] hover:border-[#B28359]/50 transition-all space-y-4 flex flex-col justify-between shadow-xs">
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <div className="w-8 h-8 rounded-lg bg-[#FDF7F0] flex items-center justify-center text-[#8C5B32]">
                        <Code2 className="w-4 h-4" />
                      </div>
                      <span className="text-[10px] text-[#8C5B32] font-mono font-semibold">.JSON Format</span>
                    </div>
                    <h3 className="font-serif-luxury text-base font-semibold text-[#1C1917]">
                  ...
                  <div className="pt-2">
                    <button
                      ...
                      className="w-full py-2.5 px-4 rounded-full bg-white hover:bg-[#F2ECE1] border border-[#E5DFD5] text-[#1C1917] font-semibold text-xs tracking-wider uppercase transition-all flex items-center justify-center gap-2"
                    >
                      <DownloadCloud className="w-4 h-4 text-[#B28359]" />
              ...
              {/* Data Summary Stats */}
              <div className="p-4 rounded-xl bg-[#FAF9F5] border border-[#E5DFD5] grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
                <div>
                  <span className="text-[10px] text-[#78716C] uppercase tracking-wider block">Total Products</span>
                  <span className="font-serif-luxury text-xl font-bold text-[#1C1917]">{products.length}</span>
                </div>
                <div>
                  <span className="text-[10px] text-[#78716C] uppercase tracking-wider block">Generated Variants</span>
                  <span className="font-serif-luxury text-xl font-bold text-[#B28359]">{totalVariants}</span>
                </div>
                <div>
                  <span className="text-[10px] text-[#78716C] uppercase tracking-wider block">Vendor Name</span>
                  <span className="text-xs font-semibold text-[#1C1917] mt-1 block">Ever After Diamonds</span>
                </div>
                <div>
                  <span className="text-[10px] text-[#78716C] uppercase tracking-wider block">Primary Currency</span>
                  <span className="text-xs font-semibold text-emerald-700 mt-1 block">GBP (£)</span>
                </div>
              </div>

              {/* Ready notice */}
              <div className="flex items-start gap-3 p-4 rounded-xl bg-emerald-50 border border-emerald-200 text-xs text-[#1C1917]">
                <Sparkles className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
                <div>
                  <strong className="text-[#1C1917]">Built for Effortless Shopify Transition:</strong>
          ...
          {activeTab === 'guide' && (
            <div className="space-y-4">
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-4 p-4 rounded-xl bg-[#FAF9F5] border border-[#E5DFD5]">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-[#1C1917]">Download the CSV from this platform</h4>
                ...
                <div className="flex items-start gap-4 p-4 rounded-xl bg-[#FAF9F5] border border-[#E5DFD5]">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-[#1C1917]">Log in to your Shopify Admin</h4>
                    <p className="text-xs text-[#78716C] mt-1">
                ...
                <div className="flex items-start gap-4 p-4 rounded-xl bg-[#FAF9F5] border border-[#E5DFD5]">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-[#1C1917]">Click "Import"</h4>
                    <p className="text-xs text-[#78716C] mt-1">
                ...
                <div className="flex items-start gap-4 p-4 rounded-xl bg-[#FAF9F5] border border-[#E5DFD5]">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-[#1C1917]">Confirm & Publish</h4>
                    <p className="text-xs text-[#78716C] mt-1">
              ...
              <div className="p-4 bg-[#FAF9F5] rounded-xl border border-[#E5DFD5] text-xs space-y-1">
                <span className="font-semibold text-[#8C5B32]">Need Shopify Theme or Custom Liquid Customization?</span>
          ...
          {activeTab === 'preview' && (
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-xs text-[#78716C]">Raw CSV Output Sample:</span>
                <button
                  onClick={handleCopy}
                  className="px-3 py-1.5 rounded-full bg-white hover:bg-[#F2ECE1] border border-[#E5DFD5] text-xs text-[#1C1917] flex items-center gap-1.5 transition-colors"
                >
              ...
              <div className="p-4 bg-[#FAF9F5] border border-[#E5DFD5] rounded-xl font-mono text-[11px] text-[#1C1917] overflow-x-auto max-h-72">
